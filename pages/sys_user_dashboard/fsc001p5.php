...
<h1>Mix Paper Cups| Delivery (<?php /* echo $_GET["ponum"] */ ?>) </h1>
					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Customer PO#" name="fsc001p5_ponum" id="fsc001p5_ponum" />
							</div>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-12 col-lg-12">
							<div class="form-group">
								<label for="">DR Number</label>
								<input type="text" class="form-control" placeholder="DR Number" name="fsc001p5_drnum" id="fsc001p5_drnum" />
							</div>
						</div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="display: none;">
							<div class="form-group">
								<label for="">StockID</label>
								<input type="text" class="form-control" placeholder="IOOID" name="fsc001p5_stockid" id="fsc001p5_stockid" value="<?php echo $_GET["id"]; ?>" />
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="display: none;">
							<div class="form-group">
								<label for="">ID</label>
								<input type="text" class="form-control" placeholder="ID" name="fsc001p5_id" id="fsc001p5_id" value="" />
								<span id="check-e"></span>
							</div>
						</div>
					</div>
...
$(document).ready(function() {
    ...
    var dataTable = $('#example').DataTable({        
        ...
        "serverSide": true,
        "ajax": {
            url: "pages_exe/sys_user_dashboard/fsc001p5_exe_dt.php",
            type: "POST",
    ...
    function submitForm() {
		...
		$.ajax({
            type: 'POST',
            url: 'pages_exe/sys_user_dashboard/fsc001p5_exe_crud.php ',
            data: data,
    ...
    $(document).on('click', '#update', function(e) {
        ...
        $.ajax({
            ...
            success: function(data, status) {
                ...
                $("#fsc001p5_ponum").val(cruddata.fsc001p5_ponum);
                $("#fsc001p5_drnum").val(cruddata.fsc001p5_drnum);
                $("#fsc001p5_id").val(cruddata.fsc001p5_id);
                ...
                $("#section_btn").attr('data-id', cruddata.fsc001p5_id);
